...
{
    public partial class VisorFacturaA5 : BaseForm
    {
        BillPrintModel _bill = new BillPrintModel();
        private bool _readOnly = false;

        public VisorFacturaA5()
        {
            InitializeComponent();
        }

        public VisorFacturaA5(BillSaveModel bill)
        {
            InitializeComponent();
        ...
        public VisorFacturaA5(BillSaveModel bill, bool readOnly)
        {
            InitializeComponent();
            _bill.Client = new List<ClientModel>();
            _bill.Client.Add(bill.Client);
        ...
        private void VisorFacturaA5_Load(object sender, EventArgs e)
        {
